...
class DetailsActivity : AppCompatActivity() {
    ...
    override fun onCreate(savedInstanceState: Bundle?) {
        ...
        try {
            ...
            // Create adapter - fixed the ArrayAdapter ambiguity
            ...
            bookSearchDropdown.setOnItemClickListener { _, _, position, _ ->
                val selectedTitle = adapter.getItem(position) ?: return@setOnItemClickListener
    ...
    private fun buildFormattedDetails(book: Book): String {
        return """
            Title: ${book.title}
